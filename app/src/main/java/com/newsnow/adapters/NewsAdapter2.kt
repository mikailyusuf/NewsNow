...
class NewsAdapter2:RecyclerView.Adapter<NewsAdapter2.NewsViewHolder>() {
    ...
    val differ = AsyncListDiffer(this@NewsAdapter2,differCallback)
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NewsAdapter2.NewsViewHolder {
    ...
    override fun onBindViewHolder(holder: NewsAdapter2.NewsViewHolder, position: Int) {
